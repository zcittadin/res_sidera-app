...
public class ProcessoTemplate {
	...
	static {
		...
		dynamicReportsComponent = cmp.horizontalList(
				cmp.image(ProcessoTemplate.class.getResource("/img/resicolor.png")).setFixedDimension(60, 60),
				cmp.verticalList(cmp.text("Resicolor").setStyle(bold22CenteredStyle)
